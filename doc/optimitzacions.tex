...
Timing del codi original sobre la maquina de proves especificada al Annex B amb la qual s'han calculat els timings i speedups de les optimitzacions d'aquest apartat:
\begin{itemize}
