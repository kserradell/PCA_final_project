...
\item{SpeedUp:  --- mirar be si aixo millora el temps}
\end{itemize}
...
Un cop hem vectoritzat dist1, hem vist que tant dist1 com dist1\_special baixaven molt a la llista temps d'execucio, i fullsearch es va quedar en primer lloc com a funció que triga més, per tant vam decidir centrar esforços en optimitzar fullsearch.

explicar code hoisting.